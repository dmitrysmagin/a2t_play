...
| opl303 | 84260 | 25346 | FRAME-DIFF | Bug 17 fixed (2026-05-19): key-off note no longer treated as valid note in TonePortamento (was 660 lines at frame 5005 region → 0). Remaining 4622 diffs: portamento starts 2 ticks later in C vs Pascal (effect_table cleared at play_line start, update_effects sees def=0 on first 2 ticks of new row). 66 each: 0, F, MB, PT. |
...
| yellowwe | 38300 | 272 | FRAME-DIFF | Previously 272 diffs (30 RT). Resolved by cumulative bug fixes. Effects: Arpeggio, FSlideDownFine, SetModulatorVol, RetrigNote, Extended. |
